    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {metrics.map((m, idx) => {
        ...
        return (
          ...
          >
            <div
              className={`absolute -right-4 -top-4 w-24 h-24 bg-current opacity-5 rounded-full blur-2xl group-hover:opacity-10 transition-opacity ${m.color}`}
            ></div>
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center border border-white/5 mb-4 ${m.bg}`}
            >
            ...
            <div
              className={`text-2xl lg:text-3xl font-bold tracking-tight font-mono ${m.color}`}
            >
